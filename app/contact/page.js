              ...
              <div className='flex-1'>
                ...
                <div className='flex flex-col items-start space-y-2 mt-4'>
                  <div className='flex items-center gap-2 text-pink-800 hover:text-pink-700'>
                    ...
                    <Link className='font-medium block' href='https://goo.gl/maps/yteuBkuL5xWJ1zaDA' target='_blank'>Get Directions</Link>
                  </div>
                  <div className='flex items-center gap-2 text-pink-800 hover:text-pink-700'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                    ...
                    <Link className='font-medium block' href='tel:+919825411321'>Appointment: +91 98254 11321</Link>
                  </div>
                  <div className='flex items-center gap-2 text-pink-800 hover:text-pink-700'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                    ...
                    <Link className='font-medium block' href='tel:+919726011321'>Call: +91 97260 11321</Link>
                  </div>
                </div>
              ...
              <div className='flex-1'>
                ...
                <div className='flex flex-col items-start space-y-2 mt-4'>
                  <div className='flex items-center gap-2 text-pink-800 hover:text-pink-700'>
                    ...
                    <Link className='font-medium block' href='https://goo.gl/maps/uMN82PpdWJ4ZQnVT8' target='_blank'>Get Directions</Link>
                  </div>
                  <div className='flex items-center gap-2 text-pink-800 hover:text-pink-700'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                      <path d="M12.75 12.75a.75.75 0 11-1.5 0 .75.75 0 011.5 0zM7.5 15.75a.75.75 0 100-1.5.75.75 0 000 1.5zM8.25 17.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zM9.75 15.75a.75.75 0 100-1.5.75.75 0 000 1.5zM10.5 17.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zM12 15.75a.75.75 0 100-1.5.75.75 0 000 1.5zM12.75 17.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zM14.25 15.75a.75.75 0 100-1.5.75.75 0 000 1.5zM15 17.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zM16.5 15.75a.75.75 0 100-1.5.75.75 0 000 1.5zM15 12.75a.75.75 0 11-1.5 0 .75.75 0 011.5 0zM16.5 13.5a.75.75 0 100-1.5.75.75 0 000 1.5z" />
                  ...
                  <div className='flex items-center gap-2 text-pink-800 hover:text-pink-700'>
                    ...
                    <Link className='font-medium block' href='tel:+919081011321'>Call: +91 90810 11321</Link>
                  </div>
                </div>
