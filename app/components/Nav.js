              ...
              {navItems.map((navItem, index) => (
                <li key={index}>
                  <Link href={navItem.link}
                    className={`text-md inline-block font-medium px-2 py-1 rounded-md transition transform duration-300 border-2  hover:border-2 hover:border-pink-800 ${navItem.button
